...
use App\Filament\Commands\FileGenerators\Resources\Traits\FormatVariableToTextTrait;
        ...
        foreach ($schema->getColumns($table) as $column) {
            ...
            if ($type['name'] === 'boolean') {
                ...
                $componentData['type'] = match (true) {
                    $componentName === 'image', str($componentName)->startsWith('image_'), str(
                        $componentName
                    )->contains('_image_'), str($componentName)->endsWith('_image') => ImageEntry::class,
